...
const inlineSvg = function () {
    document.querySelectorAll('img.svg').forEach(function (e) {
        const imgID = e.getAttribute('id');
        const imgClass = e.getAttribute('class');
        ...
        fetch(imgURL)
            ...
            (_a = e.parentNode) === null || _a === void 0 ? void 0 : _a.replaceChild(svg, e);
        });
    });
};
//Text Refactor
...
const customTooltips = function (context) {
    ...
    if (!this._chart.canvas.closest('.ninjadash-chart-container').contains(tooltipEl)) {
        ...
        this._chart.canvas.closest('.ninjadash-chart-container').appendChild(tooltipEl);
    }
...
export { inlineSvg, textRefactor, chartLinearGradient, customTooltips };
